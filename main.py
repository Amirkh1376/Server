...
access_token = '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'
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.cancel_button = Buttons('Upload', self, self.output_box)
    ...
    def on_upload_button_click(self):
        script_directory = upload_py_files_V1_0.os.path.dirname(upload_py_files_V1_0.os.path.abspath(__file__))
        directory_path = upload_py_files_V1_0.os.path.join(script_directory)
        upload_py_files_V1_0.upload_py_files(access_token, repository, directory_path, target_branch)
        # print('AA')
...
class Buttons:
    ...
    def on_button_click(self):
        ...
        if self.button.isChecked():
            ...
            elif self.button_name == "Upload":
                self.output_box.parent().on_upload_button_click()
            else:   
